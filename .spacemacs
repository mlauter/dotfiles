...
values."
  ...
  (setq-default
   ...
   dotspace ;; Map 'ESC' switch to vim normal to "jk"
  (setq evil-escape-key-sequence "jk")macs-elpa-timeout 5
...
you should place your code here."
  ...
  ;; Custom global keys
  (global-set-key (kbd "M-m d d") 'dash-at-point)
  (global-set-key (kbd "M-m d e") 'dash-at-point-with-docset)

  ;; Custom hybrid mode kbds
  (define-key evil-hybrid-state-map (kbd "M-m f z") 'fzf)
